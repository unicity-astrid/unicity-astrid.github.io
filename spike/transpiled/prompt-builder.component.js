...
const module0 = getCoreModule('prompt-builder.component.core.wasm');
const module1 = getCoreModule('prompt-builder.component.core2.wasm');
const module2 = getCoreModule('prompt-builder.component.core3.wasm');
...
const { kvDelete, kvGet, kvSet } = imports['astrid:kv/host'];
...
const { checkCapsuleCapability, clockMonotonicNs, getConfig, log, randomBytes } = imports['astrid:sys/host'];

if (checkCapsuleCapability=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'checkCapsuleCapability', was 'checkCapsuleCapability' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}


if (clockMonotonicNs=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'clockMonotonicNs', was 'clockMonotonicNs' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
let gen = (function* _initGenerator () {
  ...
  const _trampoline1 = function() {
    _debugLog('[iface="astrid:sys/host@1.0.0", function="clock-monotonic-ns"] [Instruction::CallInterface] (sync, @ enter)');
    ...
    _debugLog('[iface="astrid:sys/host@1.0.0", function="clock-monotonic-ns"][Instruction::Return]', {
      funcName: 'clock-monotonic-ns',
      paramCount: 1,
      async: false,
      postReturn: false
    });
  ...
  _trampoline1.fnName = 'astrid:sys/host@1.0.0#clockMonotonicNs';
  let exports1;
  let memory0;
  let realloc0;
  let realloc0Async;
...
const _trampoline4 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  var len1 = arg3;
  var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="astrid:sys/host@1.0.0", function="check-capsule-capability"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  const createTask = () => {
    const results = createNewCurrentTask({
      componentIdx: -1,
      isAsync: false,
      entryFnName: 'checkCapsuleCapability',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'result-catch-handler',
      callingWasmExport: false,
...
switch (variant5.tag) {
  case 'ok': {
    ...
    var {allowed: v2_0 } = e;
    dataView(memory0).setInt8(arg4 + 4, v2_0 ? 1 : 0, true);
...
_debugLog('[iface="astrid:sys/host@1.0.0", function="check-capsule-capability"][Instruction::Return]', {
  funcName: 'check-capsule-capability',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline4.fnName = 'astrid:sys/host@1.0.0#checkCapsuleCapability';
...
_trampoline5.fnName = 'astrid:sys/host@1.0.0#randomBytes';
...
_trampoline7.fnName = 'astrid:kv/host@1.0.0#kvSet';
...
_trampoline8.fnName = 'astrid:kv/host@1.0.0#kvDelete';
...
_trampoline9.fnName = 'astrid:ipc/host@1.0.0#recv';
...
_trampoline10.fnName = 'astrid:ipc/host@1.0.0#publish';
...
_trampoline11.fnName = 'astrid:ipc/host@1.0.0#subscribe';
let exports2;
let postReturn0;
...
null,
{
  ...
  paramLiftFns: [_liftFlatRecord({ fieldMetas: [['sourceUuid', _liftFlatStringAny, 8, 4],['capability', _liftFlatStringAny, 8, 4],], size32: 16, align32: 4 })],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatRecord({ fieldMetas: [['allowed', _lowerFlatBool, 1, 1 ],], size32: 1, align32: 1 }), 16, 4, 4 ],
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'capability-denied', null, 0, 0, 0 ],[ 'config-key-reserved', null, 0, 0, 0 ],[ 'too-large', null, 0, 0, 0 ],[ 'registry-unavailable', null, 0, 0, 0 ],[ 'cancelled', null, 0, 0, 0 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
...
({ exports: exports1 } = yield instantiateCore(yield module0, {
  'astrid:ipc/host@1.0.0': {
    '[method]subscription.recv': exports0['7'],
    '[resource-drop]subscription': trampoline0,
    publish: exports0['8'],
    subscribe: exports0['9'],
  },
  'astrid:kv/host@1.0.0': {
    'kv-delete': exports0['6'],
    'kv-get': exports0['4'],
    'kv-set': exports0['5'],
  },
  'astrid:sys/host@1.0.0': {
    'check-capsule-capability': exports0['2'],
    'clock-monotonic-ns': trampoline1,
    'get-config': exports0['1'],
    log: exports0['0'],
    'random-bytes': exports0['3'],
  },
}));
